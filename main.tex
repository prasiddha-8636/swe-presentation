...
% Page 6
\begin{frame}{Core Philosophy of Lean}
    \begin{center}
    ...
    \textbf{Key Concepts}
    \begin{itemize}
        \item Focus on customer needs
        \item Eliminate non-value-adding activities
        \item Improve the entire development process
        \item Build quality into every stage
        \item Deliver software quickly and continuously
    \end{itemize}
    \vspace{0.4em}
    Lean helps organizations create high-quality software faster, with lower costs and greater customer satisfaction.
\end{frame}
...
% Page 15
\begin{frame}{The 7 Principles of Lean Software Development}
    Lean software development is about doing more with less: less waste, fewer delays, and fewer surprises --- while still respecting the people who build the product.
    \vspace{0.5em}
    
    \begin{itemize}
        \item \textbf{Eliminate Waste} - cut anything that doesn't create user value
        \item \textbf{Build Quality In} - test continuously, prevent defects early
        \item \textbf{Create Knowledge} - document, share, and learn from every cycle
        \item \textbf{Defer Commitment} - decide later when you know more
        \item \textbf{Deliver Fast} - ship in small batches and iterate quickly
        \item \textbf{Respect People} - trust your team and encourage ownership
        \item \textbf{Optimize the Whole} - improve the full pipeline, not just one part
    \end{itemize}
\end{frame}
